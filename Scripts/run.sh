...
time python clr_v1.py --spins 1024 --eqs 2000 --mcs 2000 --rseed 1234 --nTemp 120 --tMin 0.5 --tMax 20.0
...
time python clrf_v1.py --spins 4096 --eqs 4000 --mcs 4000 --rseed 1234 --nTemp 120 --tMin 0.5 --tMax 20.0 --delta 1.0
time python clrf_v1.py --spins 4096 --eqs 4000 --mcs 4000 --rseed 1234 --nTemp 120 --tMin 0.5 --tMax 20.0 --delta 1.5